...
class AndroidHomeView extends StatefulWidget {
  const AndroidHomeView({super.key});

  @override
  State<AndroidHomeView> createState() => _AndroidHomeViewState();
}

class _AndroidHomeViewState extends State<AndroidHomeView> {
